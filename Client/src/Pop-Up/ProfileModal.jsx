    ...
    const modalContent = (
      <div className="fixed inset-0 bg-black/40 backdrop-blur-md flex items-center justify-center z-[100] animate-in fade-in duration-300">
        <div className="relative w-full max-w-sm">
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 text-gray-500 hover:text-gray-900 transition-colors shadow-sm cursor-pointer"
          >
            ...
            <div className="flex flex-col items-center text-center mt-4">
              ...
              <div className="w-full">
                <button
                  ...
                  className="w-full py-4 bg-gray-900 text-white rounded-2xl font-semibold tracking-wide hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none cursor-pointer"
                >
                  {isLoggingOut ? (
